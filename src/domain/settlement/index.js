...
const getById = async function ({settlementId}, enums, options = {}) {
...
const putById = async function (settlementId, payload, enums, options = {}) {
  let Logger = options.logger || centralLogger
  try {
...
const getSettlementsByParams = async function (params, enums, options = {}) {
...
const settlementEventTrigger = async function (params, enums, options = {}) {
...
const getByIdParticipantAccount = async function ({settlementId, participantId, accountId = null}, enums, options = {}) {
  let Logger = options.logger || centralLogger
  try {
